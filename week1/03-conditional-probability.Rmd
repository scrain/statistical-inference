...
* Let $A$ be a die roll of 1 or 2, $A = \{1,2\}$, $P(A) = 1/6$ 
...
$$P(Q ~|~ H) = \dfrac{P(Q \cap H)}{P(H)} = \dfrac {1/52}{13/52} = \dfrac {1}{13} = `r 1/13`$$ 
...
$$P(A \cap B) = P(A) \times P(B) = \dfrac {1}{6} \times \dfrac {1}{6} = \dfrac {1}{36} = `r 1/36`$$
...
$$P(A \cap R) = 0.90 \times 0.20 = `r 0.9 * 0.2`$$

The answer is no, it is not possible since the probability of both $A$ and $R$, $P(A \cap R)$, cannot be greater than the probability of event $A$ alone occurring.
...
`r (0.88 * 0.95) / ((0.88 * 0.95) + (0.07 * 0.05))`
$$

**FINAL ANSWER** The probability that a housing project has no asbestos given a negative test expressed as a percentage to the nearest percentage point is **100%**
